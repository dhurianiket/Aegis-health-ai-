...
export const SPECIALISTS: Record<SpecialistId, SpecialistProfile> = {
  cardiologist: {
    ...
    description: 'World-class cardiologist specializing in heart disease, arrhythmias, and hypertension',
  ...
  endocrinologist: {
    ...
    description: 'Expert in diabetes, thyroid disorders, and metabolic diseases',
  ...
  neurologist: {
    ...
    specialty: 'Neurology',
    description: 'Specializing in headache, epilepsy, stroke, and neurodegenerative diseases',
  ...
  gastroenterologist: {
    ...
    description: 'Specializing in IBS, IBD, liver diseases, GERD, and GI malignancies',
  ...
  psychiatrist: {
    ...
    description: 'Specializing in mood disorders, anxiety, and cognitive disorders',
  ...
  dermatologist: {
    ...
    description: 'Specializing in skin cancers, inflammatory skin diseases, and cosmetics',
