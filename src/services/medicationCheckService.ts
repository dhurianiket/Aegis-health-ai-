...
import { isDuplicateClass, DRUG_INTERACTIONS, isMedInCategory } from '../lib/medicationInteractionDB';

/**
 * MedicationCheckService - Services for identifying drug-drug interactions
 * and duplicate therapies.
 */
export const checkMedicationInteractions = (meds: Medication[]): HealthAlert[] => {
