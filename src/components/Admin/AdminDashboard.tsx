  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-16">
      ...
      <div className="text-center text-muted text-xs mt-8">
        Built by <a href="https://aniket.aegishealthai.co.in/" target="_blank" rel="noreferrer" className="hover:text-[var(--color-text)] underline decoration-muted transition-colors">Aniket Dhuri</a> • Version {version}
      </div>
    </div>
  );
}
