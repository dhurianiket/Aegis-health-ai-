  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto px-4 sm:px-0">
      ...
      <div className="text-center text-slate-500 text-xs mt-12 pb-8">
        Built by <a href="https://aniket.aegishealthai.co.in/" target="_blank" rel="noreferrer" className="hover:text-slate-400 underline decoration-slate-600 transition-colors">Aniket Dhuri</a> • Version {version}
      </div>
    </div>
  );
}
