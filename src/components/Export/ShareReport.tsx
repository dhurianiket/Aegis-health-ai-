                ...
                <>
                  <div className="flex items-center justify-between mb-8 print:hidden">
                    ...
                    <button
                      ...
                      aria-label="Close share report modal"
                      className="text-slate-400 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-current"
                    >
                      <X className="w-5 h-5" />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-6 border-b border-white/10 bg-slate-900 print:hidden">
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        aria-label="Go back"
                        className="p-2 bg-white/5 hover:bg-white/10 rounded-full transition-colors text-slate-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-current"
                      >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        onClick={() => setIsModalOpen(false)}
                        aria-label="Close clinical summary"
                        className="p-2 bg-white/5 hover:bg-white/10 rounded-full text-slate-300 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-current"
                      >
                        <X className="w-5 h-5" />
                      </button>
                    </div>
