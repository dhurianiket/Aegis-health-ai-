          ...
          {isOpen && (
            ...
            >
              ...
              <div className="px-6 py-4 border-b border-[var(--color-border)] flex items-center justify-between shrink-0">
                ...
                <button
                  onClick={handleToggle}
                  className="p-2 hover:bg-[var(--color-surface)] rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus:ring-[var(--color-primary)]"
                    ...
                    <div className="flex flex-col gap-2">
                      {[
                        ...
                        <button
                          ...
                          className="text-left px-4 py-3 rounded-[16px] bg-slate-900 dark:bg-[#1C1C1E] hover:opacity-90 border border-slate-700 dark:border-[#2C2C2E] text-sm font-semibold text-white transition-colors focus:outline-none focus-visible:ring-2 focus:ring-[var(--color-primary)] shadow-sm"
                        >
                          {q}
                        </button>
                      ))}
              ...
              <div className="shrink-0 px-4 py-3 border-t border-[var(--color-border)] bg-[var(--color-bg)]">
                ...
                <form onSubmit={handleSubmit} className="relative">
                  <input
                    ...
                    className={`w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-full py-3.5 pl-5 pr-24 text-[15px] font-medium text-slate-900 dark:text-slate-100 placeholder:text-slate-500 dark:placeholder:text-slate-400 focus:outline-none focus-visible:ring-2 focus:ring-[var(--color-primary)] ${isTyping || !isAlAvailable ? "pointer-events-none opacity-50" : ""} ${isListening ? "ring-2 ring-indigo-500 bg-indigo-500/5 animate-pulse" : ""}`}
                  />
                ...
                <div className="mt-2 text-center text-xs font-semibold text-slate-600 dark:text-slate-300">
                  {isAlAvailable ? "Generated by Aegis AI. Not a diagnosis." : "Please configure VITE_AEGIS_EDGE_BEARER to enable AI (edge proxy)."}
                </div>
              </div>
            </motion.div>
          )}
