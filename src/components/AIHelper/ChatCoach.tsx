              ...
              <div className="shrink-0 px-4 py-3 border-t border-[var(--color-border)] bg-[var(--color-bg)]">
                ...
                <form onSubmit={handleSubmit} className="relative">
                  <input
                    ...
                    disabled={isTyping}
                    className={`w-full bg-[var(--color-surface)] border border-transparent rounded-full py-3.5 pl-5 pr-12 text-[15px] text-[var(--color-text)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] ${isTyping ? "pointer-events-none opacity-50" : ""}`}
                  />
                  <button
                    type="submit"
