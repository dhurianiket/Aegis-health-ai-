      ...
      >
        <div className="relative z-10 space-y-6">
          ...
          <div className="pt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <button className="flex flex-col items-start p-5 bg-[var(--color-bg)] hover:bg-[var(--color-surface)] border border-[var(--color-border)] rounded-[20px] transition-all group text-left cursor-not-allowed opacity-70">
