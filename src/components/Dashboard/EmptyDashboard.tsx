    ...
    <div className="space-y-8 pb-20 max-w-4xl mx-auto">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="pt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button
              ...
              className="flex flex-col items-start p-5 bg-[var(--color-bg)] hover:bg-[var(--color-primary)]/10 border border-[var(--color-border)] hover:border-[var(--color-primary)]/30 rounded-[20px] transition-all group text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--color-primary)] dark:focus-visible:ring-offset-[#0A0A0A]"
            >
              <Upload className="w-8 h-8 text-[var(--color-primary)] mb-3 group-hover:scale-110 transition-transform" />
              <h3 className="font-semibold text-sm mb-1 text-[var(--color-text)]">
                Upload Report
              </h3>
              <p className="text-xs text-[var(--color-text-muted)]">
                PDFs or images of test results
              </p>
            </button>
            <button
              disabled
              aria-disabled="true"
              title="Coming soon"
              className="flex flex-col items-start p-5 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[20px] transition-all group text-left cursor-not-allowed opacity-70"
            >
              <Target className="w-8 h-8 text-emerald-500 mb-3 transition-transform" />
              <h3 className="font-semibold text-sm mb-1 text-[var(--color-text)]">
                Complete Profile
              </h3>
              <p className="text-xs text-[var(--color-text-muted)]">
                Add medical history & goals
              </p>
            </button>
            <button
              disabled
              ...
              className="flex flex-col items-start p-5 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[20px] transition-all group text-left cursor-not-allowed opacity-70"
            >
              <SparklesIcon className="w-8 h-8 text-indigo-500 mb-3 transition-transform" />
              <h3 className="font-semibold text-sm mb-1 text-[var(--color-text)]">
                Try AURA AI
              </h3>
              <p className="text-xs text-[var(--color-text-muted)]">
                Synthesize insights instantly
              </p>
            </button>
          </div>
          ...
          <div className="pt-4">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="flex items-center gap-3 px-8 py-4 bg-[var(--color-primary)] text-white rounded-full font-bold text-sm shadow-xl shadow-[var(--color-primary)]/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--color-primary)] dark:focus-visible:ring-offset-[#0A0A0A]"
            >
              Upload first report to unlock AI insights{" "}
      ...
      >
        <div className="flex items-center justify-between px-2">
          ...
          <div className="text-xs font-medium text-[var(--color-text-muted)] bg-[var(--color-surface)] px-3 py-1 rounded-full border border-[var(--color-border)]">
            Preview Mode
          </div>
        </div>

        <div
          className="opacity-40 pointer-events-none select-none filter blur-[2px] mb-8"
          aria-hidden="true"
        >
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
            <div className="bg-[var(--color-surface)] p-6 rounded-[24px] border border-[var(--color-border)] flex items-center gap-4">
              ...
              <div>
                <div className="h-3 w-20 bg-[var(--color-border)] rounded mb-2"></div>
                <div className="h-6 w-12 bg-indigo-500/20 rounded"></div>
              </div>
            </div>
            <div className="bg-[var(--color-surface)] p-6 rounded-[24px] border border-[var(--color-border)] flex items-center gap-4">
            ...
            <div className="bg-[var(--color-surface)] p-6 rounded-[24px] border border-[var(--color-border)] flex items-center gap-4 hidden sm:flex">
              ...
              <div>
                <div className="h-3 w-20 bg-[var(--color-border)] rounded mb-2"></div>
                <div className="h-6 w-12 bg-amber-500/20 rounded"></div>
              </div>
            </div>
          </div>
...
const SparklesIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M10 3L11.5 7.5L16 9L11.5 10.5L10 15L8.5 10.5L4 9L8.5 7.5L10 3Z"
      fill="currentColor"
    />
    <path
