  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-[10px] font-bold text-slate-400 hover:text-indigo-400 uppercase tracking-widest transition-colors focus-visible:ring-2 focus-visible:ring-current focus:outline-none rounded"
            >
              Mark all read
            </button>
            <button
              ...
              className="p-1 text-slate-500 hover:text-white transition-colors focus-visible:ring-2 focus-visible:ring-current focus:outline-none rounded-full"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar">
          {(
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-bold whitespace-nowrap transition-all border focus-visible:ring-2 focus-visible:ring-current focus:outline-none ${
                activeCategory === cat
            ...
            filteredAlerts.map((alert) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-3 opacity-0 group-hover:opacity-100 transition-opacity focus-within:opacity-100">
                    <button
                      onClick={() =>
                        alert.actionUrl &&
                        window.open(alert.actionUrl, "_blank")
                      }
                      className="text-[10px] font-black text-indigo-400 hover:text-indigo-300 uppercase tracking-widest flex items-center gap-1 focus-visible:ring-2 focus-visible:ring-current focus:outline-none rounded"
                    >
                      View Details <ChevronRight className="w-3 h-3" />
                    </button>
                    <button
                      onClick={() => dismissAlert(alert.id)}
                      className="text-[10px] font-black text-slate-600 hover:text-red-400 uppercase tracking-widest focus-visible:ring-2 focus-visible:ring-current focus:outline-none rounded"
                    >
                      Dismiss
                    </button>
                  </div>
      ...
      <div className="p-4 border-t border-white/10 bg-black/10">
        <button
          onClick={onClose}
          className="w-full py-2 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 text-xs font-bold uppercase tracking-widest rounded-xl transition-all border border-indigo-500/20 focus-visible:ring-2 focus-visible:ring-current focus:outline-none"
        >
          View All Activity
        </button>
      </div>
