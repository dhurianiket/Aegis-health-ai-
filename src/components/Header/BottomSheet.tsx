        ...
        <>
          ...
          >
            ...
            <button
              ...
              className="absolute top-4 right-4 p-2 rounded-full bg-[var(--color-surface)] text-[var(--color-text-muted)] focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus:outline-none"
            >
              <X className="w-5 h-5" />
            </button>
