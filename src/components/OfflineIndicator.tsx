          ...
          {isOffline ? (
            <>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase font-black tracking-widest opacity-70">Accessing cached data</span>
              </div>
            </>
          ) : (
            <>
              <Wifi className="w-5 h-5" />
              <span className="text-sm font-bold tracking-tight">Connection Restored</span>
            </>
          )}
        </motion.div>
      )}
