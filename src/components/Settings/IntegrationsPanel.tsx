...
export default function IntegrationsPanel({ activeProfile }: IntegrationsPanelProps) {
  const integrations = [
    {
      id: 'apple',
      name: 'Apple Health',
    ...
    },
    {
      ...
      status: 'Available',
      description: 'Import activity logs and biometric measurements from Google Account.'
    }
  ];
      ...
      <div className="bg-slate-800/40 border border-white/5 rounded-3xl overflow-hidden">
        <div className="p-8 border-b border-white/5">
          <div className="flex items-center gap-4 mb-2">
            ...
            <h3 className="text-2xl font-bold text-white tracking-tight">Data Portability</h3>
          </div>
          <p className="text-slate-400 text-sm">Export your health data in industry-standard formats for EHR compatibility.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2">
          {/* FHIR Export */}
          <div className="p-8 border-r border-white/5 hover:bg-white/5 transition-colors cursor-pointer group" onClick={() => exportToFHIR(activeProfile)}>
            ...
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
              Standardized format used by healthcare systems like Epic and Cerner for seamless record transfers.
            </p>
            <div className="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
              <CheckCircle2 className="w-3 h-3 text-emerald-400" /> V1.0.0 Compatible
            </div>
          </div>

          {/* CSV Export */}
          <div className="p-8 hover:bg-white/5 transition-colors cursor-pointer group" onClick={handleCSVExport}>
            <div className="flex items-center gap-4 mb-4">
            ...
            <p className="text-xs text-slate-500 leading-relaxed mb-6">
              Download your complete lab history and vital trends for custom analysis in Excel or Google Sheets.
            </p>
            <div className="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
              <CheckCircle2 className="w-3 h-3 text-emerald-400" /> Formatted for Analysis
            </div>
          </div>
        </div>
      </div>
