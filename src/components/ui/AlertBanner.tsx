  ...
  return (
    ...
    >
      ...
      {alert.severity === "critical" && (
        <span
          className="absolute top-0 left-0 w-1 h-full bg-red-500 animate-pulse shadow-[0_0_10px_rgba(239,68,68,0.8)]"
          aria-hidden="true"
        />
      )}

      <div
        className={`p-3 rounded-full bg-white/5 border border-white/5 shrink-0 ${styles.iconColor}`}
        aria-hidden="true"
      >
