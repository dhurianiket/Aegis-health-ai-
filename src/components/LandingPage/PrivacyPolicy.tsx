      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm leading-relaxed text-muted">
            Aegis Health AI is an early-stage health insights platform founded by Aniket Dhuri, based in Dombivli, Maharashtra, India. We are currently in a public beta phase, offering the service free for user feedback. If you have any questions about this policy, you can reach us directly at <span className="text-blue-500 font-semibold">support@aegishealthai.co.in</span>.
          </p>
        </section>
